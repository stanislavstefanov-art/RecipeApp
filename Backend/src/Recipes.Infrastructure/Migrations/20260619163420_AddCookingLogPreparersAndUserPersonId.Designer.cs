...
namespace Recipes.Infrastructure.Migrations
{
    ...
    [Migration("20260619163420_AddCookingLogPreparersAndUserPersonId")]
    partial class AddCookingLogPreparersAndUserPersonId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.CookingLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateOnly>("CookedOn")
                        .HasColumnType("date");
                    ...
                    b.ToTable("CookingLogEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.MeasurementUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.PersonMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PersonMemberships", (string)null);
                });
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.ReceiptItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.Recipe", b =>
                {
                    ...
                    b.Property<string>("_appropriateForMealTypes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.RecipeVariationIngredientOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RecipeVariationIngredientOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.ShoppingListItemSource", b =>
                {
                    ...
                    b.ToTable("ShoppingListItemSources", (string)null);
                });
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.CookingLogEntry", b =>
                {
                    ...
                    b.OwnsMany("Recipes.Domain.Entities.CookingLogPreparer", "PreparedBy", b1 =>
                        {
                            b1.Property<Guid>("CookingLogEntryId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("CookingLogEntryId", "PersonId");

                            b1.ToTable("CookingLogPreparers", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("CookingLogEntryId");
                        });
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.PersonMembership", b =>
                {
                    ...
                    b.HasOne("Recipes.Domain.Entities.Person", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.ReceiptItem", b =>
                {
                    b.HasOne("Recipes.Domain.Entities.Expense", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.RecipeVariationIngredientOverride", b =>
                {
                    b.HasOne("Recipes.Domain.Entities.RecipeVariation", null)
                        .WithMany("IngredientOverrides")
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.ShoppingListItemSource", b =>
                {
                    b.HasOne("Recipes.Domain.Entities.ShoppingListItem", null)
            ...
            modelBuilder.Entity("Recipes.Domain.Entities.RecipeVariation", b =>
                {
                    b.Navigation("IngredientOverrides");
                });
